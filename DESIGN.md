...
The default sits at **four fifths of calibrated** rather than on it, because the two failures are not symmetric: short of the mark the frame keeps grain, past it the frame smears, and only the first still reads as a photograph.
