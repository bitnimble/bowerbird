...
try {
  // bb_selftest reduces a small image, builds a blur's taps and reads a noise level off a
  // histogram of it, so the vectorised code actually executes. Loading the library proves nothing on
