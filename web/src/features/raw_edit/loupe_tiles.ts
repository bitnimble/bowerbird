 ...
 * runs over that crop and this holds what came back. That pipeline is the wasm module in this
 * page, on every host.
 *
...
export interface LoupeTile {
  rect: TileRect;
  /** The window the grade reads, which the pipeline takes as one upload. */
  tile: LocalTile;
}
...
export class LoupeTiles {
  ...
  constructor(
    ...
    private readonly renderTile: (rect: TileRect) => Promise<LocalTile>,
