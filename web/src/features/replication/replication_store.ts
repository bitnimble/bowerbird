...
import { type PairedPeer, type ReachableAddress } from '../../../../src/schemas/replication';
...
export class ReplicationStore {
  ...
  /** What to read out to the other device, this one's own addresses (§9.1). */
  @observable.shallow accessor reachable: ReachableAddress[] = [];
