...
export const PhotoRangeRequestSchema = z.object({
  scope: PhotoSelectionFields.shape.scope,
  filters: PhotoFiltersSchema.default({}),
  from: UuidSchema.nullable().default(null),
  to: UuidSchema.nullable().default(null),
});
...
// that never arrives.
export const DeletePhotosRequestSchema = z.object({ batch: UuidSchema.optional() });
