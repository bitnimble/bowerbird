...
// A constraint failure arrives as an Error carrying a SQLITE_CONSTRAINT_* code. Used to translate
// a lost pre-check race (two requests pass a uniqueness check before either commits) into a 409
