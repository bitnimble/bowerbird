...
/** How often a run that means to keep its lease should say so. */
export const LEASE_REFRESH_MS = LEASE_MS / 3;
...
export class SyncLocksRepository {
   ...
   *
   * What `scanAll` waits on before re-attempting a library it was refused
